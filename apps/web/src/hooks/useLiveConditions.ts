 ...
 *
 * A much shorter `staleTime` than the forecast queries: these are live readings
 * updated every few minutes, and the question they answer ("is it raining on
 * me?") goes stale just as fast.
 */
